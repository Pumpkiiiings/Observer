    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        for (MenuComponent comp : payload.components()) {
            if (comp instanceof TextureComponent tex) {
                ...
                if (rl != null) {
                    ...
                    graphics.blit(net.minecraft.client.renderer.RenderPipelines.GUI_TEXTURED, rl, x, y, 0f, 0f, tex.width(), tex.height(), tex.width(), tex.height());
                }
            }
        }
        ...
        for (MenuComponent comp : payload.components()) {
            if (comp instanceof TextComponent txt) {
                ...
                graphics.text(this.font, textComp, x, y, 0xFFFFFF, true);
            }
        }
    }
