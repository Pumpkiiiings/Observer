...
public class ItemComponent implements ObserverComponent {
    ...
    public void render(GuiGraphics context, DeltaTracker tickCounter) {
        ...
        // renderItem inherently handles depth and lighting for 3D item models
        context.renderItem(itemStack, (int) finalX, (int) finalY);
        context.renderItemDecorations(client.font, itemStack, (int) finalX, (int) finalY);
    ...
    private static com.mojang.blaze3d.vertex.PoseStack getPoseStackSafe(GuiGraphics context) {
        if (!poseSearched) {
            poseSearched = true;
            ...
            if (cachedPoseMethod == null) {
                for (java.lang.reflect.Field f : GuiGraphics.class.getDeclaredFields()) {
